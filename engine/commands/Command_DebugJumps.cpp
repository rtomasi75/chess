...
std::string Command_DebugJumps::JumpTableIndexToString(const int& index)
{
	...
	case JUMPTABLE_KING_CAPTURE(PIECETYPE_KNIGHT):
		return "JUMPTABLE_KING_CAPTURE(PIECETYPE_KNIGHT)";
	case JUMPTABLE_KING_CAPTURE(PIECETYPE_BISHOP):
		return "JUMPTABLE_KING_CAPTURE(PIECETYPE_BISHOP)";
	case JUMPTABLE_KING_CAPTURE(PIECETYPE_QUEEN):
		return "JUMPTABLE_KING_CAPTURE(PIECETYPE_QUEEN)";
	case JUMPTABLE_KING_CAPTURE(PIECETYPE_PAWN):
		return "JUMPTABLE_KING_CAPTURE(PIECETYPE_PAWN)";
	case JUMPTABLE_KNIGHT_QUIET:
		return "JUMPTABLE_KNIGHT_QUIET";
	case JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_KING):
		return "JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_KING)";
	case JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_ROOK):
		return "JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_ROOK)";
	case JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_KNIGHT):
		return "JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_KNIGHT)";
	case JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_BISHOP):
		return "JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_BISHOP)";
	case JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_QUEEN):
		return "JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_QUEEN)";
	case JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_PAWN):
		return "JUMPTABLE_KNIGHT_CAPTURE(PIECETYPE_PAWN)";
	default:
